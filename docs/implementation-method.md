...
최신 구현률과 남은 리스크는 `docs/implementation-status.md`에서 관리하고, 실행용 todo는 `docs/implementation-backlog.md`에서 관리합니다.
...
새 기능 추가 또는 구조 변경 후에는 상태 문서의 영역별 구현률과 백로그의 작업 항목을 함께 갱신합니다.
