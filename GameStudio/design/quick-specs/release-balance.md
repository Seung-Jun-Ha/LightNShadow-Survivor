...
3. Round 3 ends only when the boss is defeated. Boss patterns remain disabled until a later release.
...
| Move speed | Current player move speed | +10% move speed |
...
| Round | Spawn Interval | Monster Health | XP Per Kill |
| ---: | ---: | ---: | ---: |
| 1 | 1 second | 2 | 3 |
| 2 | 2 seconds | 4 | 5 |
| 3 | Boss only | 30 | Game clear |
...
- The release boss has no shield, dash, teleport, split, blob, or minion-spawn behavior.
