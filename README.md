<p align="center">
  <h1 align="center">Codex Game Studio Framework</h1>
  <p align="center">
...
<p align="center">
  ...
  <a href="codex/skills"><img src="https://img.shields.io/badge/skills-73-green" alt="73 Skills"></a>
  ...
  <a href="https://openai.com/codex"><img src="https://img.shields.io/badge/built%20for-Codex-f5f5f5?logo=openai" alt="Built for Codex"></a>
...
**Codex Game Studio Framework** solves this by giving your AI session the structure of a real studio. Instead of one general-purpose assistant, you get 49 specialized agents organized into a studio hierarchy ??directors who guard the vision, department leads who own their domains, and specialists who do the hands-on work. Each agent has defined responsibilities, escalation paths, and quality gates.
...
- [Codex Skill Workflows](#codex-skill-workflows)
...
| **Skills** | 73 | Codex Skill Workflows for every workflow phase (`/start`, `/design-system`, `/create-epics`, `/create-stories`, `/dev-story`, `/story-done`, etc.) |
...
Ask Codex to run or follow to access all 73 skills:
...
- [Codex](https://openai.com/codex) (`npm install -g @anthropic-ai/Codex-code`)
...
1. **Clone or use as template**:
   ```bash
   git clone https://github.com/Donchitos/Codex-Game-Studio-Framework.git my-game
   cd my-game
   ```
...
codex/
  ...
  skills/                           # 73 Codex Skill Workflows (subdirectory per skill)
...
- **Discussions** ??[GitHub Discussions](https://github.com/Donchitos/Codex-Game-Studio-Framework/discussions) for questions, ideas, and showcasing what you've built
- **Issues** ??[Bug reports and feature requests](https://github.com/Donchitos/Codex-Game-Studio-Framework/issues)

---

## Supporting This Project

Codex Game Studio Framework is free and open source. If it saves you time or helps you ship your game, consider supporting continued development:
...
*Built for Codex. Maintained and extended ??contributions welcome via [GitHub Discussions](https://github.com/Donchitos/Codex-Game-Studio-Framework/discussions).*
...
이 파일은 Codex Game Studio Framework에서 '.\README.md' 경로가 담당하는 원문 지침과 참조 정보를 보존합니다. Codex 환경에서는 AGENTS.md, codex/ 지식 베이스, Unity 우선 엔진 참조를 기준으로 읽으면 됩니다. 핵심 결정은 원문을 삭제하지 않고, Codex 기준 경로와 Unity 제작 흐름을 함께 이해하도록 보조 설명을 추가하는 것입니다.
