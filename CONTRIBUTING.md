...
- Skills live in `codex/skills/<name>/SKILL.md` ??the subdirectory format is
...
- Model tier: `GPT-5.4-Mini` for read-only status checks, `GPT-5.5` for multi-document
  synthesis and phase gates, `GPT-5.4` for everything else
